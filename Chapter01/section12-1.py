...
conn = sqlite3.connect("./Chapter01/resource/database.db", isolation_level=None)
...
# 데이터 삽입"
c.execute(
    "INSERT INTO users VALUES(1,'Kim', 'Kim@naver.com', '010-0000-0000', \
    'kim.com', ?)",
    (nowDatetime,),
)
...
# Many 삽입(튜플, 리스트)
userList = (
    (3, "Lee", "Lee@naver.net", "010-2222-2222", "Lee.com", nowDatetime),
    (4, "Cho", "Cho@daum.net", "010-3333-3333", "Cho.com", nowDatetime),
    (5, "Yoo", "Yoo@google.net", "010-4444-4444", "Yoo.com", nowDatetime),
)
