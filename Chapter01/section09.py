...
# 예제1
with open("./Chapter01/resource/test.txt", "w") as f:
    f.write("niceman!")

# 예제2
with open("./Chapter01/resource/test.txt", "a") as f:
    f.write("niceman!!")

# 예제3
from random import randint

with open("./Chapter01/resource/score2.txt", "w") as f:
    for cnt in range(6):
...
with open("./Chapter01/resource/test2.txt", "w") as f:
    list = ["Kim\n", "Park\n", "Lee\n"]
    f.writelines(list)

# 예제5
with open("./Chapter01/resource/test3.txt", "w") as f:
